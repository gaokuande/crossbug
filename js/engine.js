...
var Engine = (function(global) {
    ...
    function render() {
        ...
        for (row = 0; row < numRows; row++) {
            for (col = 0; col < numCols; col++) {
                 ...
                 */
                 if((col==5&&row==2)){
                    ctx.drawImage(Resources.get('images/stone-block.png'), col * 50, row * 40,50,85);continue;}
                    if(col>3&&col<7&&row==1){
                        ctx.drawImage(Resources.get('images/stone-block.png'), col * 50, row * 40,50,85);continue;
                    }
                ctx.drawImage(Resources.get(rowImages[row]), col * 50, row * 40,50,85);
            }
        }
        ctx.drawImage(Resources.get('images/palace.png'), 200, 10,150,100);
        return success?hello():lifeCount >= 1 ? renderEntities() : (lifeCount = 0,  // Life set to 0
            ctx.clearRect(0, 0, 550, 610), // Clears the board
            ctx.fillStyle = 'yellow',
            ctx.fillRect(0, 0, 550, 300), // Sets the rect indigo
    ...
    function hello(){
            refresh=false;
            ctx.clearRect(0, 0, 550, 610), // Clears the board
            ctx.fillStyle = '#afaf69',
            ctx.fillRect(0, 0, 550, 610), // Sets the rect indigo
            showscore(score);
