var score = 0,
    ...
    posY = [110, 150, 190, 230, 270, 310, 350, 390, 430, 470], // An Array of Y positions
    posX = [0, 50, 100, 150, 200,250, 300,350, 400,450, 500], // An Array of X positions for gems
...
Enemy.prototype.update = function(dt) {
    ...
    return this.x <= 550 ? this.x += this.speed * dt : this.reset();
};

Enemy.prototype.reset = function() { // Reset for the enemy bugs
    this.sprite = this.randomSprite(); // Sets a random enemy sprite
    this.x = randomX[Math.floor(Math.random() * 6)]; // Sets a random X position
    this.y = posY[Math.floor(Math.random() * 10)]; // Sets a random Y position
...
Heart.prototype.render=function() { // Method that renders the sprite
        ctx.drawImage(Resources.get(this.sprite), this.x+10, this.y+22 ,30,50);
    },
...
TurnBack.prototype.update = function(dt) {
    if (this.x <= 550 && turn === 0) {
        this.x += this.speed * dt;
        if (this.x > 550) { // var turn becomes 1
...
Guardian.prototype.reset = function() {
    this.x = 550;
    this.y = posY[Math.floor(Math.random() * 10)];
...
var Player = function (sprite) {
    Character.call(this, sprite);
    this.x = 250; // Start position of player
    this.y = 510;
};
...
Gem.prototype.render=function() { // Method that renders the sprite
        ctx.drawImage(Resources.get(this.sprite), this.x+10, this.y+20,30,50);
    },
...
Gem.prototype.itemReset = function() {
    ...
    this.x = posX[Math.floor(Math.random() * 11)];
    this.y = posY[Math.floor(Math.random() * 10)];
};
...
var enemy5 = new Enemy('images/enemy-bug.png');
var enemy6 = new Enemy('images/enemy-bug.png');
var enemy7 = new Enemy('images/enemy-bug.png');
var enemy8 = new Enemy('images/enemy-bug.png');
var enemy9 = new Enemy('images/enemy-bug.png');
var enemy10 = new DiagonalBug('images/enemy-bug.png');
var enemy11 = new Heart('images/Heart.png');
var enemy12 = new TurnBack();
var allEnemies = [enemy0, enemy1, enemy2, enemy3, enemy4, enemy5, enemy6, enemy7,enemy8, enemy9, enemy10, enemy11, enemy12];
